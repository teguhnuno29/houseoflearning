...
<head>
	...
	<title>Tentang Developer - House of Learning</title>
	<!-- General CSS Files -->
	<link rel="icon" href="<?= base_url('assets/') ?>img/hol.png" type="image/png">
		...
		<div class="main-wrapper">
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-title">Admin - House of Learning</div>
				...
				<section class="section">
					<div class="">
						<div class="hero text-white hero-bg-image" data-background="https://images.unsplash.com/photo-1492571350019-22de08371fd3?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=649&q=80">
							<div class="col-md-4 mx-auto rounded-circle bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
								<img src="<?= base_url('assets/img/') ?>IT401.jpg" class="card-img-top rounded-circle img-responsive" alt="...">
							</div>
						</div>
					</div>
					<br>
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Kelompok Pem Web 2</h2>
								<hr>
								<p class="card-text">Pengembang Web yang perfeksionis dengan pengalaman satu tahun sebagai Pengembang Web dan Desainer Web. Terampil dalam Mendesain dan mengembangkan Situs Web. Keterampilan komunikasi tertulis dan lisan yang sangat baik; mampu menjelaskan masalah perangkat lunak yang rumit dengan istilah yang mudah dipahami. </p>
							</div>
						</div>
					</div>
					<br>
			...
			<footer class="main-footer">
				<div class="text-center">
					Copyright &copy; 2024 <div class="bullet"></div><a href="https://github.com/">Kelompok Pem Web 2</a>
				</div>
			</footer>
			<!-- End Footer -->

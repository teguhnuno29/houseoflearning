			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Project House of Learning </h1>
					</div>
					<div class="">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Tentang House of Learning</h2>
								<hr>
								<p class="card-text">Web Edukasi Open Source yang dibuat oleh Kelompok Pem Web 2. <br> House of Learning adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. <br> House of Learning dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
							</div>
						</div>
					</div>
				</section>

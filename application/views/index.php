...
<section class="home_banner_area">
	<div class="banner_inner d-flex align-items-center">
		<div class="overlay bg-parallax" data-stellar-ratio="0.9" data-stellar-vertical-offset="0" data-background="">
			<img data-aos="fade-down" data-aos-duration="1800" src="<?= base_url('assets/') ?>img/banner/banner-welcome.png" alt="" srcset="">
		</div>
		<div class="container">
			<div class="banner_content text-center">
				<h3 data-aos="fade-up" data-aos-duration="1600">Belajar Dimana Saja & Kapan Saja <br /> Mudah Dengan House of Learning</h3>
				<p data-aos="fade-up" data-aos-duration="1900">Dengan House of Learning kemudahan kegiatan belajar mengajar dapat terpenuhi. Para guru dan siswa dapat
					belajar meski banyak halangan atau rintangan. Nikmati Pembelajaran terstruktur dan efektif menggunakan House of Learning serta kemudahan belajar dengan menggunakan aplikasi kami. </p>
		...
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					<h2 data-aos="fade-up" data-aos-duration="2000">House of Learning Dibuat Untuk Meningkatkan Kualitas Pembelajaran Di Indonesia</h2>
					...
					<a href="https://github.com/"><button data-aos="fade-up" data-aos-duration="2400" class="bubbly-button">Download House of Learning <span class="lnr lnr-arrow-right"></span></button></a>
				</div>
			</div>
		</div>
	</div>
...
<section class="courses_area p_40">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1600">Pelajaran Yang Tersedia di House of Learning</h2>
		...
		<div class="row courses_inner">
				...
				<div class="grid_inner">
					<div class="grid_item wd55">
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							<img src="<?= base_url('assets/') ?>img/courses/mtk.png" alt="">
							<div class="hover_text">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-user"></i>Guru Matematika SMKN Jakarta</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="grid_item wd44">
						<div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
							<img src="<?= base_url('assets/') ?>img/courses/IPA.png" alt="">
							<div class="hover_text">
								<a class="cat" href="#">Gratis</a>
								<a href="javaScript:void(0);">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru IPA SMKN Jakarta</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="grid_item wd44">
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							<img src="<?= base_url('assets/') ?>img/courses/inggris.png" alt="">
							<div class="hover_text">
								<a class="cat" href="#">Gratis</a>
								<a href="javaScript:void(0);">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru English SMKN Jakarta</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="grid_item wd55">
						<div class="courses_item" data-aos="fade-up" data-aos-duration="1800">
							<img src="<?= base_url('assets/') ?>img/courses/b.indo.png" alt="">
							<div class="hover_text">
								<a class="cat" href="#">Gratis</a>
								<a href="javaScript:void(0);">
								...
								<ul class="list">
									...
									<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
									<li><a href="#"><i class="lnr lnr-user"></i> Guru Indonesia SMKN Jakarta</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="col-lg-3">
				<div class="course_item" data-aos="fade-left" data-aos-duration="1800">
					<img src="<?= base_url('assets/') ?>img/courses/PAI.png" alt="">
					<div class="hover_text">
						<a class="cat" href="#">Gratis</a>
						<a href="javaScript:void(0);">
						...
						<ul class="list">
							...
							<li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
							<li><a href="#"><i class="lnr lnr-user"></i> Guru Agama SMKN Jakarta</a></li>
						</ul>
					</div>
				</div>
			</div>
...
<section class="team_area p_20">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1800">Testimonial Para Siswa House of Learning</h2>

...
<head>
    ...
    <meta content="House of Learning dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="House of Learning, E-learning, Open Source, Kelompok Pem Web 2, github, programmer indonesia" name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/hol.png" type="image/png">
    <title>House of Learning - Belajar Dimana Saja & Kapan Saja !</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="mailto:apps.houseoflearning@gmail.com">apps.houseoflearning@gmail.com</a>
                </div>
            </div>
        </div>
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img src="<?= base_url('assets/') ?>img/loggo.png" alt=""></a>

...
<section class="banner_area">
    <div class="banner_inner d-flex align-items-center">
        <div class="overlay bg-parallax" data-stellar-ratio="0.9" data-stellar-vertical-offset="0" data-background="">
            <img data-aos="fade-down" data-aos-duration="1800" src="<?= base_url('assets/') ?>img/banner/tentang.png" alt="" srcset="">
        </div>
        <div class="container">
            <div class="banner_content text-center">
                <h2 data-aos="fade-up" data-aos-duration="1600">Tentang House of Learning</h2>
...
<section class="about_area p_60">
    <div class="container">
        <div class="main_title">
            <h2 data-aos="fade-up" data-aos-duration="1600" style="font-size: 33px !important;">Tentang House of Learning - Web Edukasi Open Source</h2>
            <p data-aos="fade-up" data-aos-duration="1800">House of Learning adalah Web Edukasi Open-Source yang dibuat oleh <a href="https://web.facebook.com/">Kelompok Pem Web 2.</a> Website
                ...
                kosong atau pun keadaan yang tidak terduga apapun karena House of Learning dapat diakses dimana saja dan
                kapan saja.
            </p>
        </div>
        <div class="row about_inner">
            ...
            <div class="col-lg-6">
                <div class="video_area" id="video">
                    <img class="img-fluid" src="<?= base_url('assets/') ?>img/videocrud.jpeg" alt="" />
                    <a class="popup-youtube" href="https://www.youtube.com/watch?v=8VobLSN4x-Y">

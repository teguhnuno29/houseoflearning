...
<head>
    ...
    <title>Selamat datang - <?php
                            ...
                            echo $data['user']['nama'];
                            ?> - House of Learning Student Page</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down" data-aos-duration="1400">Selamat Datang
                        di House of Learning <span style="font-size: 40px;">👋🏻
                        </span> </h1>
                    <p>Hello Students! , Ini merupakan halaman utama House of Learning ! Silahkan pilih kelas yang akan kamu
                        akses
